...
@Test
    void test1_validPassport() {
        Person personManager = createPersonManager();

        boolean result = personManager.addID("P001", LocalDate.of(2000,1,
            1), IDType.PASSPORT, "AB123456",
...
//Demonstrates critical testing by identifying a limitation in the current implementation.
    ...
    void test2_invalidDriverLicence() {
        ...
        boolean result = personManager.addID("P002", LocalDate.of(1999,5,
            5), IDType.DRIVER_LICENSE, "CD123",
...
//Purpose: Confirms format validation is enforced correctly.
    ...
    void test3_invalidMedicare() {
        ...
        boolean result = personManager.addID("P003", LocalDate.of(1980,3,
            3), IDType.MEDICARE, "12345A789",
                LocalDate.of(2020,1,1), LocalDate.of(2030,1,1), "Australia");
...
//Purpose: Ensures age restrictions are correctly applied.
    ...
    void test4_under18() {
        ...
        boolean result = personManager.addID("P004", LocalDate.of(2010,3,
            1), IDType.PASSPORT, "AB123456",
                LocalDate.of(2020,1,1), LocalDate.of(2030,1,1), "Australia");
...
//Purpose: Confirms duplicate IDs are prevented.
    ...
    void test5_duplicateID() {
        ...
        boolean first = personManager.addID("P005", LocalDate.of(2000,1,
            1), IDType.PASSPORT, "EF123456",
                LocalDate.of(2020,1,1), LocalDate.of(2030,1,
                    1), "Australia");

        boolean second = personManager.addID("P006", LocalDate.of(1990,1,
            1), IDType.DRIVER_LICENSE, "EF123456",
                LocalDate.of(2022,1,1), LocalDate.of(2029,1,
                    1), "Australia");
